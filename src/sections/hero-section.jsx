...
export default function HeroSection() {
    return (
        <section className="flex flex-col items-center -mt-18">
           ...
           <motion.h1 
    className="text-center text-5xl leading-[60px] md:text-6xl md:leading-[70px] mt-4 font-semibold max-w-2xl mx-auto"
...
>
    ...
    Precision Ag-Tech for Everyone
            ...
            <motion.p className="text-center text-base max-w-lg mt-2"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
              Three critical missions. One robot. Master pollination, precision spraying, and AI-driven diagnosis.
            </motion.p>
